  ...
  return (
    <>
      ...
      <fieldset className="flex flex-col gap-3 rounded-lg border border-line p-4">
        <legend className="px-1 text-sm font-semibold text-ink">{t("costSection")}</legend>
      ...
      <fieldset className="flex flex-col gap-3 rounded-lg border border-line p-4">
        <legend className="px-1 text-sm font-semibold text-ink">{t("datesSection")}</legend>
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="flex flex-col gap-1.5">
      ...
      <fieldset className="flex flex-col gap-3 rounded-lg border border-line p-4">
        <legend className="px-1 text-sm font-semibold text-ink">{t("assignmentSection")}</legend>
        <CompanyField
          idPrefix={idPrefix}
          companies={companies}
      ...
      <fieldset className="flex flex-col gap-3 rounded-lg border border-line p-4">
        <legend className="px-1 text-sm font-semibold text-ink">{t("documentSection")}</legend>
        <div className="flex flex-col gap-1.5">
